...
-- Vulcanus
if mods["space-age"] then
    data.raw.item["foundry"].subgroup = "foundry"
    data.raw.item["foundry"].order = "a"
    data.raw.item["big-mining-drill"].subgroup = "mining-big"
    data.raw.item["big-mining-drill"].order = "a"
    data.raw.recipe["molten-iron-from-lava"].subgroup = "metallurgy"
    data.raw.recipe["molten-copper-from-lava"].subgroup = "metallurgy"
    data.raw.recipe["molten-iron"].subgroup = "metallurgy"
    data.raw.recipe["molten-copper"].subgroup = "metallurgy"
    data.raw.recipe["casting-iron"].subgroup = "metallurgy-plates"
    data.raw.recipe["casting-copper"].subgroup = "metallurgy-plates"
    data.raw.recipe["casting-steel"].subgroup = "metallurgy-plates"
    data.raw.recipe["casting-iron-gear-wheel"].subgroup = "metallurgy-items"
    data.raw.recipe["casting-iron-stick"].subgroup = "metallurgy-items"
    data.raw.recipe["casting-pipe"].subgroup = "metallurgy-items"
    data.raw.recipe["casting-pipe-to-ground"].subgroup = "metallurgy-items"
    data.raw.recipe["casting-low-density-structure"].subgroup = "metallurgy-items"
    data.raw.recipe["concrete-from-molten-iron"].subgroup = "metallurgy-items"
    data.raw.recipe["casting-copper-cable"].subgroup = "metallurgy-items"
    data.raw.item["calcite"].subgroup = "metallurgy-tungsten"
    data.raw.item["tungsten-ore"].subgroup = "metallurgy-tungsten"
    data.raw.item["tungsten-plate"].subgroup = "metallurgy-tungsten"
    data.raw.item["tungsten-carbide"].subgroup = "metallurgy-tungsten"
    data.raw.recipe["tungsten-plate"].subgroup = "metallurgy-tungsten"
    data.raw.recipe["tungsten-carbide"].subgroup = "metallurgy-tungsten"
end

-- Fulgora
if mods["space-age"] then
    data.raw.item["electromagnetic-plant"].subgroup = "electromagnetic"
    data.raw.item["electromagnetic-plant"].order = "a"
    data.raw.item["lightning-rod"].subgroup = "rod"
    data.raw.item["lightning-rod"].order = "a"
    data.raw.item["lightning-collector"].subgroup = "collector"
    data.raw.item["lightning-collector"].order = "a"
    data.raw.recipe["scrap-recycling"].subgroup = "resources"
    data.raw.recipe["holmium-plate"].subgroup = "resources"
    data.raw.item["holmium-plate"].subgroup = "resources"
    data.raw.recipe["superconductor"].subgroup = "resources"
    data.raw.item["superconductor"].subgroup = "resources"
    data.raw.recipe["supercapacitor"].subgroup = "resources"
    data.raw.item["supercapacitor"].subgroup = "resources"
    data.raw.item["holmium-ore"].subgroup = "resources"
    data.raw.item["scrap"].subgroup = "resources"
    data.raw.recipe["holmium-solution"].subgroup = "liquids"
    data.raw.recipe["electrolyte"].subgroup = "liquids"
end

-- Gleba
if mods["space-age"] then
    data.raw.item["agricultural-tower"].subgroup = "agricultural-tower"
    data.raw.item["agricultural-tower"].order = "a"
    data.raw.item["biochamber"].subgroup = "biochamber"
    data.raw.item["biochamber"].order = "a"
    data.raw.item["captive-biter-spawner"].subgroup = "captive"
    data.raw.item["captive-biter-spawner"].order = "a"
    data.raw.recipe["yumako-processing"].subgroup = "agricultural-processing"
    data.raw.recipe["jellynut-processing"].subgroup = "agricultural-processing"
    data.raw.recipe["nutrients-from-spoilage"].subgroup = "nutrient"
    data.raw.recipe["nutrients-from-yumako-mash"].subgroup = "nutrient"
    data.raw.recipe["nutrients-from-bioflux"].subgroup = "nutrient"
    data.raw.recipe["copper-bacteria"].subgroup = "seeds"
    data.raw.recipe["iron-bacteria"].subgroup = "seeds"
    data.raw.recipe["pentapod-egg"].subgroup = "seeds"
    data.raw.item["yumako-seed"].subgroup = "seeds"
    data.raw.item["jellynut-seed"].subgroup = "seeds"
    data.raw.recipe["copper-bacteria-cultivation"].subgroup = "cultivation"
    data.raw.recipe["iron-bacteria-cultivation"].subgroup = "cultivation"
    data.raw.recipe["rocket-fuel-from-jelly"].subgroup = "items"
    data.raw.recipe["bioflux"].subgroup = "items"
    data.raw.recipe["bioplastic"].subgroup = "items"
    data.raw.recipe["biosulfur"].subgroup = "items"
    data.raw.recipe["carbon-fiber"].subgroup = "items"
    data.raw.recipe["burnt-spoilage"].subgroup = "items"
    data.raw.capsule["yumako"].subgroup = "items"
    data.raw.capsule["jellynut"].subgroup = "items"
    data.raw.item["copper-bacteria"].subgroup = "items"
    data.raw.item["iron-bacteria"].subgroup = "items"
    data.raw.item["spoilage"].subgroup = "items"
    data.raw.item["nutrients"].subgroup = "items"
    data.raw.capsule["bioflux"].subgroup = "items2"
    data.raw.capsule["yumako-mash"].subgroup = "items2"
    data.raw.capsule["jelly"].subgroup = "items2"
    data.raw.item["carbon-fiber"].subgroup = "items2"
    data.raw.item["biter-egg"].subgroup = "items2"
    data.raw.item["pentapod-egg"].subgroup = "items2"
    data.raw.recipe["biolubricant"].subgroup = "liquids"
end

-- Aquilo
if mods["space-age"] then
    data.raw.item["cryogenic-plant"].subgroup = "cryogenic"
    data.raw.item["cryogenic-plant"].order = "a"
    data.raw.item["heating-tower"].subgroup = "heating-tower"
