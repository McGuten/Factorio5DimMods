...
local FallbackConfig = {
    ...
    base = {
        ...
        spitter = {
            ...
            [2]  = { scale = 0.60, health = 26,   damage = 15,  range = 14, speed = 0.17, healing = 0.0055 },
            [3]  = { scale = 0.70, health = 52,   damage = 22,  range = 15, speed = 0.16, healing = 0.0085 },
            [4]  = { scale = 0.85, health = 104,  damage = 34,  range = 16, speed = 0.15, healing = 0.014 },
            [5]  = { scale = 1.00, health = 208,  damage = 50,  range = 17, speed = 0.14, healing = 0.0245 },
            [6]  = { scale = 1.15, health = 416,  damage = 76,  range = 18, speed = 0.13, healing = 0.042 },
            [7]  = { scale = 1.30, health = 832,  damage = 114, range = 19, speed = 0.12, healing = 0.0695 },
            [8]  = { scale = 1.50, health = 1664, damage = 170, range = 20, speed = 0.11, healing = 0.126 },
            [9]  = { scale = 1.80, health = 3328, damage = 256, range = 22, speed = 0.10, healing = 0.233 },
            [10] = { scale = 2.20, health = 6656, damage = 384, range = 25, speed = 0.09, healing = 0.462 }
        },
        worm = {
