-------------------------------------------------------------------------------
-- 5Dim's Battlefield - Acid Turret Generation
-- Turret that fires acid rounds creating corrosive splashes
-- Uses gun-turret graphics as base with yellow-green tint
-------------------------------------------------------------------------------
...
local techConfig = {
    ...
    [2] = {
        ...
        prerequisites = { "5d-acid-turret-1" }
    },
    [3] = {
        techName = "5d-acid-turret-3",
        countMultiplier = 3,
        basePacks = {
            { "automation-science-pack", 1 },
            { "logistic-science-pack", 1 },
        ...
        prerequisites = { "5d-acid-turret-2" }
    },
    [4] = {
        techName = "5d-acid-turret-4",
        countMultiplier = 4,
        basePacks = {
            { "automation-science-pack", 1 },
            { "logistic-science-pack", 1 },
        ...
        prerequisites = { "5d-acid-turret-3", "chemical-science-pack" }
    },
    [5] = {
        techName = "5d-acid-turret-5",
        countMultiplier = 5,
        basePacks = {
            { "automation-science-pack", 1 },
            { "logistic-science-pack", 1 },
        ...
        prerequisites = { "5d-acid-turret-4" }
    },
    [6] = {
        techName = "5d-acid-turret-6",
        countMultiplier = 6,
        basePacks = {
            { "automation-science-pack", 1 },
            { "logistic-science-pack", 1 },
...
-- Acid round projectile
data:extend({
    {
        type = "projectile",
        name = "5d-acid-round-projectile",
        flags = { "not-on-map" },
        acceleration = 0,
        action = {
            type = "direct",
    ...
    },
    {
        ...
        icon = "__base__/graphics/icons/slowdown-capsule.png",
        icon_size = 64,
        ammo_category = "5d-acid-rounds",
        ammo_type = {
            action = {
                type = "direct",
                action_delivery = {
                    type = "projectile",
                    projectile = "5d-acid-round-projectile",
                    starting_speed = 1
                }
            }
        },
        ...
        order = "b[special-ammo]-b[acid-rounds]",
        stack_size = 200
    }
})

-- Recipe for acid rounds
data:extend({
    {
        type = "recipe",
        name = "5d-acid-rounds",
        ...
        results = { { type = "item", name = "5d-acid-rounds", amount = 1 } }
    }
})
...
for tier = 1, 10 do
    ...
    if techConfig[tier] then
        ...
        -- First tier also unlocks acid rounds recipe
        if tier == 1 then
            table.insert(effects, {
                type = "unlock-recipe",
                recipe = "5d-acid-rounds"
            })
        end
