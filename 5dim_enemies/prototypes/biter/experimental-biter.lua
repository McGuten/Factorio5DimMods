...
experimentalBiter.absorptions_to_join_attack = { pollution = 1000 }
...
experimentalBiterLaser.absorptions_to_join_attack = { pollution = 1000 }
...
experimentalBiterPhysical.absorptions_to_join_attack = { pollution = 1000 }
...
-- experimentalBiterSwimmer.absorptions_to_join_attack = { pollution = 1000 }
...
-- experimentalBiterClimber.absorptions_to_join_attack = { pollution = 1000 }
...
experimentalBiterSpawner.autoplace = enemy_autoplace.enemy_spawner_autoplace("enemy_autoplace_base(0, 98)")
