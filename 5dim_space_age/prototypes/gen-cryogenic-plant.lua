-------------------------------------------------------------------------------
-- 5Dim's Space Age - Cryogenic Plant Generation
-- Uses the centralized cost system from 5dim_core
-------------------------------------------------------------------------------

require("__5dim_core__.lib.space-age.generation-cryogenic-plant")
...
for tier = 1, 10 do
    ...
    if tier < 10 then
        nextUpgrade = "5d-cryogenic-plant-" .. string.format("%02d", tier + 1)
    end
