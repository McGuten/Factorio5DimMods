...
SharedConfig.BossConfig = {
    ...
    -- Doubled from 125 to halve boss healing-per-tick (healing = health/(healing_time*60)).
    healing_time = 250
}
...
SharedConfig.BaseStats = {
    biter = {
        [1]  = { scale = 0.50, health = 20,    damage = 7,   speed = 0.22, healing = 0.0065 },
        [2]  = { scale = 0.60, health = 40,    damage = 11,  speed = 0.21, healing = 0.0085 },
        [3]  = { scale = 0.70, health = 80,    damage = 16,  speed = 0.20, healing = 0.0135 },
        [4]  = { scale = 0.85, health = 160,   damage = 24,  speed = 0.19, healing = 0.021 },
        [5]  = { scale = 1.00, health = 320,   damage = 36,  speed = 0.18, healing = 0.0375 },
        [6]  = { scale = 1.15, health = 640,   damage = 54,  speed = 0.17, healing = 0.064 },
        [7]  = { scale = 1.30, health = 1280,  damage = 81,  speed = 0.16, healing = 0.1065 },
        [8]  = { scale = 1.50, health = 2560,  damage = 122, speed = 0.15, healing = 0.194 },
        [9]  = { scale = 1.80, health = 5120,  damage = 182, speed = 0.14, healing = 0.3585 },
        [10] = { scale = 2.20, health = 10240, damage = 274, speed = 0.13, healing = 0.711 }
    },
    spitter = {
        [1]  = { scale = 0.50, health = 13,   damage = 10,  range = 13, speed = 0.18, healing = 0.0045 },
        [2]  = { scale = 0.60, health = 26,   damage = 15,  range = 15, speed = 0.17, healing = 0.0055 },
        [3]  = { scale = 0.70, health = 52,   damage = 22,  range = 17, speed = 0.16, healing = 0.0085 },
        [4]  = { scale = 0.85, health = 104,  damage = 34,  range = 19, speed = 0.15, healing = 0.014 },
        [5]  = { scale = 1.00, health = 208,  damage = 50,  range = 21, speed = 0.14, healing = 0.0245 },
        [6]  = { scale = 1.15, health = 416,  damage = 76,  range = 23, speed = 0.13, healing = 0.042 },
        [7]  = { scale = 1.30, health = 832,  damage = 114, range = 25, speed = 0.12, healing = 0.0695 },
        [8]  = { scale = 1.50, health = 1664, damage = 170, range = 27, speed = 0.11, healing = 0.126 },
        [9]  = { scale = 1.80, health = 3328, damage = 256, range = 29, speed = 0.10, healing = 0.233 },
        [10] = { scale = 2.20, health = 6656, damage = 384, range = 31, speed = 0.09, healing = 0.462 }
    },
    worm = {
        [1]  = { scale = 0.55, health = 200,  damage = 25,  range = 22, speed = 0, healing = 0.022 },
        [2]  = { scale = 0.62, health = 300,  damage = 35,  range = 24, speed = 0, healing = 0.028 },
        [3]  = { scale = 0.70, health = 450,  damage = 49,  range = 26, speed = 0, healing = 0.0375 },
        [4]  = { scale = 0.78, health = 675,  damage = 69,  range = 28, speed = 0, healing = 0.051 },
        [5]  = { scale = 0.88, health = 1013, damage = 96,  range = 30, speed = 0, healing = 0.0705 },
        [6]  = { scale = 0.98, health = 1519, damage = 135, range = 33, speed = 0, healing = 0.0975 },
        [7]  = { scale = 1.10, health = 2278, damage = 189, range = 36, speed = 0, healing = 0.1355 },
        [8]  = { scale = 1.25, health = 3418, damage = 264, range = 40, speed = 0, healing = 0.190 },
        [9]  = { scale = 1.45, health = 5127, damage = 370, range = 45, speed = 0, healing = 0.267 },
        [10] = { scale = 1.70, health = 7690, damage = 518, range = 52, speed = 0, healing = 0.377 }
    }
}
