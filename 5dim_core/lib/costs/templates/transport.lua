-------------------------------------------------------------------------------
-- 5Dim's Mod - Recipe Templates (Transport)
-- Templates for pumps, inserters, and belts
-------------------------------------------------------------------------------
...
-- Bulk Inserter templates
Templates.bulkInserter = {
    [1] = {
...
-- Stack Inserter templates (Space Age)
Templates.stackInserter = {
    [1] = {
        { type = "item", name = "bulk-inserter", amount = 1 },
        { type = "item", name = "processing-unit", amount = 1 },
