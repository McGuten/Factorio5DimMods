function genChemicalPlants(inputs)
    ...
    item.icon =
        "__5dim_automatization__/graphics/icon/chemical-plant/chemical-plant-icon-" .. inputs.number .. ".png"
    ...
    entity.animation.east.layers[1].hr_version.filename =
        "__5dim_automatization__/graphics/entities/chemical-plant/chemical-plant-" .. inputs.number .. ".png"
