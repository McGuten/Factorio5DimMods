...
| Recurso | Categoria | Complejidad | Notas |
| --- | --- | --- | --- |
| Ninguno nuevo de uso general | Biologico | Alta | En este catalogo Gleba queda reducida a jelly y carbon-fiber; no se consideran fluidos propios como recurso de diseño |
...
- Gleba queda reducida en este rediseño a jelly y carbon-fiber, y debe quedarse casi siempre dentro de familias biologicas o muy tematizadas.
